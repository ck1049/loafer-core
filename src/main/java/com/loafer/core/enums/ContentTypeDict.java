...
public enum ContentTypeDict {
    ...
    public static ContentTypeDict getByCentType(String centType) {
        for (ContentTypeDict contentTypeDict : ContentTypeDict.values()) {
            if (contentTypeDict.getCentType().equals(centType)) {
